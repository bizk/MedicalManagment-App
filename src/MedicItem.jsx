...
import { Dialog, Card,IconButton } from 'material-bread';
...
export default class MedicItem extends React.Component {
    ...
    cancelBookingModal() {
        this.setState({cancelBooking: true, selectedBooking: this.props.booking.bookingId});
        if (this.props.booking.status === "") this.setState({modalBookingTest: "LIBRE - Dia: " + this.props.booking.day + " - " + this.props.booking.time_start +
            " a " + this.props.booking.time_end})
        else this.setState({modalBookingTest: "Dia: " + this.props.booking.day + " - " + this.props.booking.time_start +
